...
def add_shape(slide, shape_type, left, top, width, height, fill_color, line_color=None, hollow=False, shadow=False):
    # Efeito de sombreamento moderno UI/UX
    if shadow:
        shd = slide.shapes.add_shape(shape_type, left + Inches(0.12), top + Inches(0.12), width, height)
        shd.fill.solid()
        shd.fill.fore_color.rgb = RGBColor(5, 7, 10) # Sombra muito escura e profunda
        shd.line.color.rgb = RGBColor(5, 7, 10)
...
add_shape(slide1, MSO_SHAPE.RECTANGLE, Inches(0.5), Inches(2.6), Inches(0.1), Inches(2.5), CYAN, shadow=True)
...
add_text(slide1, "Alessandro Lopes e Guilherme Silva | Campus Itapecuru Mirim, UEMA", Inches(0.8), Inches(6.5), Inches(8), Inches(0.5), Pt(14), GRAY, bold=True)
...
add_shape(slide2, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(2), Inches(2.8), Inches(4), CARD_BG, shadow=True)
...
add_shape(slide2, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(3.6), Inches(2), Inches(2.8), Inches(4), CARD_BG, shadow=True)
...
add_shape(slide2, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(6.7), Inches(2), Inches(2.8), Inches(4), CARD_BG, shadow=True)
...
add_shape(slide3, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(2), Inches(3.8), Inches(4), CARD_BG, shadow=True)
...
add_shape(slide3, MSO_SHAPE.OVAL, Inches(4.8), Inches(2.4), Inches(0.2), Inches(0.2), CYAN, shadow=True)
add_shape(slide3, MSO_SHAPE.RECTANGLE, Inches(4.88), Inches(2.6), Inches(0.04), Inches(1.2), CYAN)
add_shape(slide3, MSO_SHAPE.OVAL, Inches(4.8), Inches(3.8), Inches(0.2), Inches(0.2), CYAN, shadow=True)
add_shape(slide3, MSO_SHAPE.RECTANGLE, Inches(4.88), Inches(4.0), Inches(0.04), Inches(1.2), CYAN)
add_shape(slide3, MSO_SHAPE.OVAL, Inches(4.8), Inches(5.2), Inches(0.2), Inches(0.2), CYAN, shadow=True)
...
add_shape(slide4, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(1.5), Inches(9), Inches(2), CYAN, shadow=True)
...
add_shape(slide4, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(4), Inches(2.8), Inches(2.5), CARD_BG, shadow=True)
...
add_shape(slide4, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(3.6), Inches(4), Inches(2.8), Inches(2.5), CARD_BG, shadow=True)
...
add_shape(slide4, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(6.7), Inches(4), Inches(2.8), Inches(2.5), CARD_BG, shadow=True)
...
for i in range(3):
    add_shape(slide5, MSO_SHAPE.OVAL, Inches(1.2 + i*2.8), Inches(2.5), Inches(2), Inches(2), BG_COLOR, line_color=CYAN, hollow=True, shadow=True)
...
for t in techs:
    add_shape(slide6, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(t[2]), Inches(t[3]), Inches(2.8), Inches(2), CARD_BG, shadow=True)
...
add_shape(slide7, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(2.5), Inches(2.2), Inches(2.5), CARD_BG, shadow=True)
...
add_shape(slide7, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(3.5), Inches(2), Inches(3), Inches(3.5), CARD_BG, shadow=True)
...
add_shape(slide7, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(7.3), Inches(2.1), Inches(2.2), Inches(0.8), BG_COLOR, line_color=CYAN, hollow=True, shadow=True)
...
add_shape(slide7, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(7.3), Inches(3.2), Inches(2.2), Inches(0.8), BG_COLOR, line_color=CYAN, hollow=True, shadow=True)
add_text(slide7, "PubChem API", Inches(7.3), Inches(3.45), Inches(2.2), Inches(0.5), Pt(14), CYAN, bold=True, alignment=PP_ALIGN.CENTER)

add_shape(slide7, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(7.3), Inches(4.3), Inches(2.2), Inches(0.8), BG_COLOR, line_color=CYAN, hollow=True, shadow=True)
...
add_shape(slide8, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(1.5), Inches(9), Inches(5.5), CARD_BG, shadow=True)
add_shape(slide8, MSO_SHAPE.RECTANGLE, Inches(0.5), Inches(1.5), Inches(9), Inches(0.4), RGBColor(10, 15, 20))
add_shape(slide8, MSO_SHAPE.OVAL, Inches(0.7), Inches(1.65), Inches(0.15), Inches(0.15), RGBColor(255, 95, 86))
add_shape(slide8, MSO_SHAPE.OVAL, Inches(0.95), Inches(1.65), Inches(0.15), Inches(0.15), RGBColor(255, 189, 46))
add_shape(slide8, MSO_SHAPE.OVAL, Inches(1.2), Inches(1.65), Inches(0.15), Inches(0.15), RGBColor(39, 201, 63))
...
add_text(slide9, "DEMONSTRAÇÃO: DER E BD", Inches(0.5), Inches(0.5), Inches(9), Inches(1), Pt(32), CYAN, bold=True)

add_shape(slide9, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(1.5), Inches(9), Inches(5.5), CARD_BG, shadow=True)
...
add_text(slide10, "FLUXO DE INTEGRAÇÃO", Inches(0.5), Inches(0.5), Inches(9), Inches(1), Pt(32), CYAN, bold=True)

add_shape(slide10, MSO_SHAPE.RECTANGLE, Inches(0.5), Inches(4), Inches(9), Inches(0.05), CYAN, shadow=True)
...
for i in range(5):
    add_shape(slide10, MSO_SHAPE.OVAL, Inches(1 + i*1.75), Inches(3.85), Inches(0.35), Inches(0.35), BG_COLOR, line_color=CYAN, shadow=True)
...
add_shape(slide11, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(1.8), Inches(9), Inches(2.2), CYAN, shadow=True)
...
add_shape(slide11, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.5), Inches(4.3), Inches(4.3), Inches(2.4), CARD_BG, shadow=True)
...
add_shape(slide11, MSO_SHAPE.ROUNDED_RECTANGLE, Inches(5.2), Inches(4.3), Inches(4.3), Inches(2.4), CARD_BG, shadow=True)
...
prs.save('Apresentacao_Premium_Quimiochat_Shadows.pptx')
print("Apresentacao_Premium_Quimiochat_Shadows.pptx gerada com sucesso.")
